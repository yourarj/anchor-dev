    ...
    switch (field.type) {
      ...
      default: {
        if ("vec" in field.type) {
          ...
          let mapKeyTy = field.type.map[0];
          let mapValueTy = field.type.map[1];
          let keyLayout = IdlCoder.fieldLayout(
            {
              name: undefined,
              type: mapKeyTy,
            },
          ...
          let valueLayout = IdlCoder.fieldLayout(
            {
              name: undefined,
              type: mapValueTy,
            },
          ...
          return borsh.map(keyLayout, valueLayout, fieldName);
        } else {
